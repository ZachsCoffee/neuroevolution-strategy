...
public class RNN implements TimeNetwork{
    ...
    protected RNN(int numberOfFeatures, Function hiddenFunction, Function outputFunction, boolean isRandom){
        ...
        wVector = new Random().doubles(numberOfFeatures, -1, 1).toArray();
        uVector = new Random().doubles(numberOfFeatures, -1, 1).toArray();
        vVector = new Random().doubles(numberOfFeatures, -1, 1).toArray();
