 ...
 * @author Zachs
 */
public class TWIExchangeProblem  extends Problem implements EvolutionComponents, MLProblem{

    public TWIExchangeProblem(int epochs) {
        super(
            "./src/dataset/TWIExchange/train.txt", 
            "./src/dataset/TWIExchange/validation.txt", 
            "./src/dataset/TWIExchange/test.txt"
        );
